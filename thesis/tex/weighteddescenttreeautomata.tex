...
\begin{proof}
  ...
  $u = \tuple{q_{1}, 0}\dots\tuple{q_{n}, 0}\in\mathcal{Q\times D}^{*}$
  \begin{align*}
    \mu_{r}(\cyl(u)) &= G_{q_{0}}^{t_{\alpha}(\epsilon)}(q_{1},0)\cdot
      ...
      \delta(q_{1},t_{\alpha}(0),q_{2})\dots\delta(q_{n-1},t_{\alpha}(0^{n}),q_{n})\\
  ...
  equivalent regarind positive as well as almost-sure acceptance.
\end{proof}
