...
\begin{proof}
  ...
  \cite[Theorem 22.1]{Bauer} is the product algebra
  $\mathcal{R}_{\mathcal{A}}\otimes\mathcal{B}(D)$ generated by the
  sets $\compRuns(r)\times\cyl(p)$ for all partial runs $r$ and $p\in D^{*}$.

  To ease the following argument we restrict our attention to
