...
\begin{proof}
  ...
  and $p\in D^{*}$. Lemma \ref{lem:balancedruns} allows to consider balanced
  runs.
...
its boundness and therefore deduce the measureability of 
$\set{r\in\Runs\mid\mu_{B}(\Acc(r)) = 1 }$ as $g^{-1}(1)$. This lays the basis 
for 
\begin{proposition}
