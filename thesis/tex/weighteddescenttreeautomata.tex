...
$\tuple{\Runs, \mathcal{R}_{\mathcal{A}},\mu_{t}}\otimes\tuple{
  \Paths, \mathcal{B}(D), \mu_{B}}$ allows to deduce by Theorem
...
\begin{proof}
  ...
  which induces the equivalences of the languages of $\mathcal{A}$ and
  $\mathcal{C}$ by Proposition \ref{prop:pwabyf}.
...
This equivalence allows to formulate the emptiness problem of a choiceless
...
unique run $r$. The central observation is that these measures coincide.
\begin{lemma}
...
The constructions used for Theorem \ref{thm:wdtaemptinesspomdp} and Corollary
...
For \acp{PBA} we know that more expressive acceptance conditions allows to
