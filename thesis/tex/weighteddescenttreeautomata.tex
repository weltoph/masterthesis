...
with an alternative semantics, namely the runs are equipped with a uniform 
...
uniformly distributed \acp{WDTA}. Although we do not present immediate results,
we discuss this question in the following. Therefore, we examine the
...
consequences that the choice of the transition probabilities matters. In this 
context we discuss some results from \cite{RandAutoInfTrees}. Firstly, we 
...
\begin{drawing}
  \caption{
    ...
    proven lack of closure under it. Additionally, we used $B\nsubseteq P$ to 
