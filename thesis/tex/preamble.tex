...
{\begin{mdframed}[backgroundcolor=green!40]\begin{localexample}}
{\end{localexample}\end{mdframed}}

\newtheorem{localdef}{Definition}[section]
\newenvironment{definition}[1][]
{\begin{mdframed}[backgroundcolor=gray!20]\begin{localdef}\ifthenelse{\equal{#1}{}}{}{\emph{\textbf{#1}}:}\leavevmode\\}
