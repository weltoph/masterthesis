...
next state, specifically $\mathcal{P}$ chooses a state $p$ by the probability
...
\begin{drawing}
  ...
  \end{center}
\end{drawing}
Let $v = u_{0}\dots u_{n}$ be such a finite prefix of $\alpha$. First we 
...
Furthermore, we describe the expressive-wise superiority of positively 
...
$\varphi_{\alpha}(w) = \alpha_{\size{w}}$ can be defined. On the other hand,
