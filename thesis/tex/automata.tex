...
Büchi condition due to the positive nature of its semantics. In fact we can use
this language to separate the expressiveness of tree automata as in
\begin{theorem}
