...
\begin{definition}[Graph Games]
  ...
  Büchi, co-Büchi, Streett, Rabin, Muller or Parity conditions.
\end{definition}
...
a game with this property \emph{determined}. \fxfatal{Find reference}
As we explore this topic later on in more detail we state here without detailed
explanation that Muller and therefore also Büchi, co-Büchi, Streett, Rabin and
Parity conditions are Borel. And the following theorem
\begin{theorem}[Martin's Theorem]
  All Borel-games are determined.
\end{theorem}
By this we can deduce the determinacy of all the games we consider
\begin{corollary}
  All Büchi-, co-Büchi-, Streett-, Rabin-, Muller- and Parity-games are
  determined.
\end{corollary}
