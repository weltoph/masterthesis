...
\begin{example}
  ...
  how probable it is to stay in $q_{2}$, namely $\lambda^{\size{w}}$. 
  Naturally, the probability to \enquote{fail} such an experiment is 
  $1-\lambda^{\size{w}}$. Due to the equivalent behaviour of $q_{3}$ and 
  $q_{0}$ all these experiments are independent and therefore, consistenly 
  failing these experiments with $a$-sequences of length $k_{1}, k_{2},\dots$ 
  starting from the $m$-th experiment happens with probability
  \begin{equation*}
  ...
  $c_{m}\cdot p_{m}$ and addivity of a probability measure that the probability
  of non-accepting runs is
  \begin{equation*}
