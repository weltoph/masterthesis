...
may be resolved (see \cite{MullerSchupp}). This result does unfortunately not
translate unconstraint to the weighted case.
\begin{proposition}
...
\end{corollary}
\begin{proof}
  In above construction the measure of the one path of a run in a
