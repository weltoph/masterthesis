...
\begin{proof}[Proof-sketch]
  ...
  Complementation requires a rather involved construction which we do not 
  present here; but we mention an intermediate construction, namely a 
  \ac{PRA} $\mathcal{R}$ associated with a \ac{PBA} $\mathcal{P}$. The 
