...
\end{equation}
Naturally, we want to define acceptance in terms of the induced measure of a
run on the set of paths that satisfy the target $T_{\mathcal{A}}$ when
...
Naturally, we say that $\mathcal{A}$ accepts $t$ if such an
