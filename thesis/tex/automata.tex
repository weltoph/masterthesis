...
\begin{example}
  ...
  in Figure \ref{fig:nbafina}. The argument that this \ac{NBA} accepts 
  ...
  \ref{fig:detautofina}. We use the different acceptance conditions to model
  ...
  \label{ex:fina}
\end{example}
We radically compress the theory to $\omega$-automata by stating the following
\begin{theorem}
...
explained and also re-used later on.
\begin{proof}
  ...
  \end{theorem}
  And also we avoid the technicalities of determinization of an \ac{NBA} by
  simply stating
  \begin{theorem}
...
\begin{proof}
  ...
  \end{equation}
  Since Rabin conditions can be expressed as Muller conditions
