...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{overlayarea}{\textwidth}{0.8\textheight}
      ...
      \begin{onlyenv}<8-13>
        \begin{itemize}
          \item<8-> \enquote{input-/output-game with unobservable stochastic
            background}
      ...
      \begin{onlyenv}<14->
        \begin{columns}
          ...
          \begin{column}{0.5\textwidth}
            \begin{center}
              \resizebox{\textwidth}{!}{
                \uncover<15>{\includegraphics{tikz/synthesispbagame.pdf}}
              }
            \end{center}
          \end{column}
        \end{columns}
        ...
        \begin{itemize}
          \item<5-> for a strategy $s$:
            $\begin{aligned}
              ...
              = 1\text{ iff }\\
              &\mu_{\alpha}(\Acc_{\buechi}(Q))\text{ for almost all }\alpha.
            \end{aligned}$
